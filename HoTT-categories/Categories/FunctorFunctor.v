Require Export Functor Cat Category.Duals FunctorCategory SetCategory.
...
Section FunctorFunctor.
  ...
  Definition FunctorFunctor_ObjectOf (C : PreCategory)
  : Object [Cat^op, Cat].
  Proof.
    refine (Build_Functor (Cat^op) Cat
                          (fun D => ([C, D.1]; _))
                          _
                          _
                          _).

  Definition FunctorFunctor : Object [Cat, [Cat^op, SetCat]].
    hnf.
